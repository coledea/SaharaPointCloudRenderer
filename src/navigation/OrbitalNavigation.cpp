...
void OrbitalNavigation::onMouseMoveLeftButton(QPointF move, float move_speed, [[maybe_unused]] float look_speed)
{
...
void OrbitalNavigation::onMouseMoveRightButton(QPointF move, [[maybe_unused]] float move_speed, float look_speed)
{
