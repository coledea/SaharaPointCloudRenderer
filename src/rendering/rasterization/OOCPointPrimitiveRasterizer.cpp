...
std::set<geometry::AttributeSpecification> OOCPointPrimitiveRasterizer::necessaryAttributes() noexcept
{
	return { { geometry::AttributeType::Vector3D, geometry::AttributeSemantic::Position } };
}
