...
FloatParameterWidget::FloatParameterWidget(rendering::RangeParameter<float>* parameter, QWidget* parent)
	: ParameterWidget(
		  *parameter,
	...
	, m_parameter(parameter)
{
	...
	connect(&m_slider_and_spinbox, &SliderAndSpinBoxFloat::valueChanged, m_parameter, &rendering::RangeParameter<float>::setValue);
}

void FloatParameterWidget::onParameterValueChanged()
{
